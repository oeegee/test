...
import com.lge.config.StarConfig; // 2010.10.23 minji.bae@lge.com SKT-OTA
...
public class SpecialCharSequenceMgr {
    ...
    private static final String SKT_OTA_OPEN_MODE = "#758353266#646#";    // 2010.10.23 minji.bae@lge.com SKT-OTA [LGE_LAB1]
    private static final String OTA_CODE_KT = "*147359*682*";    // 2010.10.23 minji.bae@lge.com KT-OTA [LGE_LAB1]
    ...
    static boolean handleCharsForLockedDevice(Context context,
        ...
        if (handlePinEntry(context, dialString, pukInputActivity)
            || handleOTACodeKT(context, dialString)    // 2010.10.23 minji.bae@lge.com KT-OTA [LGE_LAB1]
            || handleSKTOTAOpenMode(context,dialString)    // 2010.10.23 minji.bae@lge.com SKT-OTA [LGE_LAB1]
        ) {
            return true;
        }
    ...
    // 2010.10.23 minji.bae@lge.com SKT-OTA [START_LGE_LAB1]
    static boolean handleSKTOTAOpenMode(Context context, String input) {	
        if ("SKT".equals(StarConfig.OPERATOR)) {

            int len = input.length();
            if (len > 14 && input.equals(SKT_OTA_OPEN_MODE)) {
                Intent intent = new Intent();
                intent.setClassName("com.lge.ota", "com.lge.ota.SKTNoUSIMActivity");
    ...
    // 2010.10.23 minji.bae@lge.com SKT-OTA [END_LGE_LAB1]

    // 2010.10.23 minji.bae@lge.com KT-OTA [START_LGE_LAB1]
    static boolean handleOTACodeKT(Context context, String input) {
        // Hidden code KT- *147359*682* LGE_CHANGE [kyungah.lim@lge.com] 2010-03-19 KT-OTA   
        int len = input.length();
        if (len > 11 && input.equals(OTA_CODE_KT)) {
            Intent intent = new Intent();
            // intent.setClassName("com.lge.ota", "com.lge.ota.KTOTAMainActivity");
            intent.setClassName("com.lge.ota", "com.lge.ota.KTNoUSIMActivity");
    ...
    // 2010.10.23 minji.bae@lge.com KT-OTA [END_LGE_LAB1]
