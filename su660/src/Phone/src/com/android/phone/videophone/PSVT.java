 ...
 *
 */
public class PSVT extends VTWrapper implements VideoTelephonyEngine.OnStatusChangeListener  {
	public static final String LOG_TAG = "PSVT";
...
//				vtEngine.prestart(mCallPrefs, nearHolder, farHolder, VideoTelephonyEngine.CamIdSet.backCamera);
	...
	public void OnStatusCallback(int vtStatusType, int statusArg1) {
		...
		case VideoTelephonyEngine.EV_VENDORID:
			...
			log("Remote VendorID Type " + mRemoteVendorID.vendorIdType + "Product Number " + mRemoteVendorID.productNumber);
			break;

		case VideoTelephonyEngine.EV_UII:
			//vtEngine.receiveUserInputIndication(remoteUII);
			log("UserInputIndication userInputType" + remoteUII.userInputType);
			log("UserInputIndication string" + remoteUII.userString);
			break;
