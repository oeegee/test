...
import com.android.internal.telephony.gsm.FacilityLock;
import com.android.internal.telephony.CommandsInterface;
// LGE_BARRING END

// 2010-02-23, CALL_BARRING_SWI : Call Barring From Swift
import com.android.phone.CallBarringSetting;
...
//20101103, kyengwhan.jee@lge.com, merged [START]
//[Start][2010.10.27]jinseok.choi@lge.com - Disable FDN Menu when SIM State Not Ready
import com.android.internal.telephony.IccCard;
//[End][2010.10.27]jinseok.choi@lge.com - Disable FDN Menu when SIM State Not Ready
//20101103, kyengwhan.jee@lge.com, merged [END]
...
// LGE_VT START
import com.android.phone.videophone.VTSetting;
// LGE_VT END

public class CallFeaturesSetting extends TimeConsumingPreferenceActivity
...
// LGE_CALL_COSTS START
    private static final String BUTTON_CALL_COST_KEY   = "button_call_cost_key";
// LGE_CALL_COSTS END
// 20100314 LGE_CALL_COSTS START
    private static final String BUTTON_CALL_DURATIONS_KEY   = "button_cd_expand_key";
    private static final String BUTTON_CD_EXPAND_KEY = "button_cd_expand_key";    
// 2010-03-15, Call Duration cutestar@lge.com END
    
// 20100315 LGE EXCUSE_MESSAGES START_TELEWORKS_PARK HYUN UK
    private static final String BUTTON_EXCUSE_MESSAGES_KEY = "button_excuse_messages_key";
//  LGE EXCUSE_MESSAGES END_TELEWORKS_PARK HYUN UK 

//2010.10.29 seungjun.seo@lge.com CallSettings HomeKey Answer Mode Add [START_LGE_LAB1]
	private static final String ANSWERMODE_KEY = "answer_select_mode";
//2010.10.29 seungjun.seo@lge.com CallSettings HomeKey Answer Mode Add [START_LGE_LAB1]

// 20100315 LGE_CPHS_INFO_NUMBERS START
    private static final String BUTTON_INFO_NUMBERS_KEY   = "button_info_numbers_key";
// LGE_CPHS_INFO_NUMBERS END
//20100804 jongwany.lee@lge.com attached this file EXCUSE MESSAGE
...
// LGE_AUTO_REDIAL START
    private static final String BUTTON_AR_KEY    = "button_ar_key";
// LGE_AUTO_REDIAL END
//20100314 LGE_CALL_SETTINGS_MENUTREE_CHANGED START
/*
// LGE_BARRING START
    private static final String BUTTON_CB_ALL = "button_cba_key";
    private static final String BUTTON_CB_O    = "button_cbo_key";
    private static final String BUTTON_CB_I   = "button_cbi_key";
    private static final String BUTTON_CB_OFF   = "button_cb_off_key";
*/    
    private static final String BUTTON_CB_AO = "button_cbao_key";
    private static final String BUTTON_CB_OI   = "button_cboi_key";
    private static final String BUTTON_CB_OICEHC   = "button_cboicehc_key";
    private static final String BUTTON_CB_AI   = "button_cbai_key";
    private static final String BUTTON_CB_IA   = "button_cbia_key";
//20100314 LGE_CALL_SETTINGS_MENUTREE_CHANGED END 
 
    private static final String BUTTON_CB_EXPAND_KEY  = "button_cb_expand_key";

// LGE_VT START
    private static final String BUTTON_CB_VT_SETTING_KEY  = "button_video_call_settings_key";
// LGE_VT END

    private static final int EVENT_CB_EXECUTED = 200;
  
    private static final int PASS_DIALOG = 100;
    private static final int CB_READING_DIALOG = 200;

    private String pass = "";
    private String fac = "";
    private EditText mPassDialogText;

    private Preference mLastBarringPref;
    private PreferenceScreen mButtonCBExpand;
//20100314 LGE_CALL_SETTINGS_MENUTREE_CHANGED START
/*	
    private Preference mButtonCBA;
    private ListPreference mButtonCBI;
    private ListPreference mButtonCBO;
    private Preference mButtonOff;
*/
    private Preference mButtonCBAO;
    private Preference mButtonCBOI;
    private Preference mButtonCBOICEHC;
    private Preference mButtonCBAI;
    private Preference mButtonCBIA;
//20100314 LGE_CALL_SETTINGS_MENUTREE_CHANGED END 
// LGE_BARRING END
// LGE_VT START
    private PreferenceScreen mButtonVTSetting;
    private Intent mVTSettingIntent;
// LGE_VT END

// LGE_AUTO_REDIAL START
    private CheckBoxPreference mButtonAR;
// LGE_AUTO_REDIAL END

	//AnswerMode ADD
	private CheckBoxPreference mAnswerModeCheckBoxPreference;

    private Intent mContactListIntent;
// LGE_CALL_COSTS START
    private Intent mCallCostSettingIntent;
// LGE_CALL_COSTS END
//  20100315LGE EXCUSE_MESSAGES START_TELEWORKS_PARK HYUN UK 
    private Intent mExcuseMessagesIntent;
//  20100315LGE EXCUSE_MESSAGES END_TELEWORKS_PARK HYUN UK 
//20100804 jongwany.lee@lge.com attached it for EXCUSE MESSAGE
// LGE_CPHS_INFO_NUMBERS START
    private Intent mInfoNumbersIntent;
// LGE_CPHS_INFO_NUMBERS END

    // 2010-03-15, Call Duration cutestar@lge.com
    private Intent mCDSettingIntent;
// 2010-02-23, CALL_BARRING_SWI : Call Barring
	private Intent mCBSettingIntent;
...
// LGE_CALL_BARRING START
    private static final int CB_RESPONSE_ERROR = 503;
    private static final int CB_EXCEPTION_ERROR = 504;
// LGE_CALL_BARRING END
...
// LGE_CALL_COSTS START
    private PreferenceScreen mSubMenuCallCostSettings;
// LGE_CALL_COSTS END
//  20100315 LGE EXCUSE_MESSAGES START_TELEWORKS_PARK HYUN UK 
    private PreferenceScreen mSubMenuExcuseMessages;
//  20100315 LGE EXCUSE_MESSAGES END_TELEWORKS_PARK HYUN UK 
//20100804 jongwany.lee@lge.com attached it for EXCUSE MESSAGE

// LGE_CPHS_INFO_NUMBERS START
    private PreferenceScreen mSubMenuInfoNumbers;
// LGE_CPHS_INFO_NUMBERS END
    private CLIRListPreference mCLIRButton;
    // 2010-03-15, Call Duration cutestar@lge.com
    private PreferenceScreen mButtonCDExpand;
...
// LGE_AUTO_REDIAL START
        if (preference == mButtonAR) {
            Settings.System.putInt(getContentResolver(),
                    Settings.System.AUTOMATIC_REDIAL, mButtonAR.isChecked()?1:0);
        } else
// LGE_AUTO_REDIAL END
// LGE_VT START
	if(preference == mButtonVTSetting)
	{
		return false;
	} else
// LGE_VT END
...
// LGE_TWO_LINE_SERVICE END
            return true;
// LGE_CALL_COSTS START
        } else if (preference == mSubMenuCallCostSettings) {
            // let the intent handler from the caller take care of the
            // navigation to the CallCost screen.
            return false;
        }
        // LGE_CALL_COSTS END
    //  LGE EXCUSE_MESSAGES START_TELEWORKS_PARK HYUN UK 
        else if (preference == mSubMenuExcuseMessages){
        	return false;
        }
//20100804 jongwany.lee@lge.com attached it for EXCUSE MESSAGE
    //  20100315 LGE EXCUSE_MESSAGES END_TELEWORKS_PARK HYUN UK 

        /*  20100510 cutestar@lge.com  Blocked for LGE Menu Tree.
        // LGE_CPHS_INFO_NUMBERS START
        else if (preference == mSubMenuInfoNumbers) {
            // Let the intent handler from the caller take care of the
            // navigation to the InformationNumbersActivity screen.
            return false;
        }
        // LGE_CPHS_INFO_NUMBERS END
		*/
        ...
        // 2010-03-15, Call Duration cutestar@lge.com
        else if (preference == mButtonCDExpand) {
            // Let the intent handler from the caller take care of the
            // navigation to the InformationNumbersActivity screen.
            return false;
        }
        
		// 2010-02-23, CALL_BARRING_SWI
        else if (preference == mButtonCBExpand)
        {
        	Log.d(LOG_TAG, "CallFeatrueSetting.java/preference==mButtonCBExpand"); 
            // let the intent handler from the caller take care of the
            // navigation to Call barring setting screen.
            return false;
        }
		//2010.10.29 seungjun.seo@lge.com CallSettings HomeKey Answer Mode Add [START_LGE_LAB1]	
		else if(preference == mAnswerModeCheckBoxPreference) {
			android.provider.Settings.Secure.putInt(getContentResolver(),
							android.provider.Settings.Secure.ANSWER_SETTING,
							mAnswerModeCheckBoxPreference.isChecked() ? 1 : 0);
...
// LGE_CALL_BARRING START
                (id == VOICEMAIL_DIALOG_CONFIRM) || (id == CB_RESPONSE_ERROR) || (id == CB_EXCEPTION_ERROR)) {
// LGE_CALL_BARRING END
...
// LGE_CALL_BARRING START
                id == VOICEMAIL_REVERTING_DIALOG || id == CB_READING_DIALOG) {
// LGE_CALL_BARRING END
    ...
    protected void onCreate(Bundle icicle) {
		...
		if(StarConfig.OPERATOR.equals("SKT")){
			addPreferencesFromResource(R.xml.call_feature_setting_skt);
		}else{
        ...
        if(StarConfig.OPERATOR.equals("SKT") == false){
            ...
            IccCard.State state = iccCard.getState();
        
            if (DBG) log("IccCard.State : " + state.toString());
        
            mSubMenuFDNSettings = (PreferenceScreen) prefSet.findPreference(BUTTON_FDN_KEY);
        
            if(state != IccCard.State.READY)
            {
                mSubMenuFDNSettings.setEnabled(false);
                if (DBG) log("IccCard.State Not Ready : setEnabled - false");
            }
            else
            {
                mSubMenuFDNSettings.setEnabled(true);
                if (DBG) log("IccCard.State Ready : setEnabled - true");
            }
            //[End][2010.10.27]jinseok.choi@lge.com - Disable FDN Menu when SIM State Not Ready
        }
        //20101103, kyengwhan.jee@lge.com, merged [END]
        ...
        if (!getResources().getBoolean(R.bool.world_phone)) {
			...
			if(StarConfig.OPERATOR.equals("SKT") == false){
	                addPreferencesFromResource(R.xml.hub_call_settings);

	                mButtonCBExpand = (PreferenceScreen)findPreference(BUTTON_CB_EXPAND_KEY);
					// LGE_AUTO_REDIAL START
					mButtonAR    = (CheckBoxPreference) findPreference(BUTTON_AR_KEY);
					mButtonAR.setChecked(Settings.System.getInt(getContentResolver(),Settings.System.AUTOMATIC_REDIAL,0) > 0);
					// LGE_AUTO_REDIAL END
					mSubMenuCallCostSettings = (PreferenceScreen)findPreference(BUTTON_CALL_COST_KEY);
				}
				else
				{
					//2010.10.29 seungjun.seo@lge.com CallSettings HomeKey Answer Mode Add [START_LGE_LAB1]
					mAnswerModeCheckBoxPreference = (CheckBoxPreference)getPreferenceScreen().findPreference(ANSWERMODE_KEY);
					//2010.10.29 seungjun.seo@lge.com CallSettings HomeKey Answer Mode Add [END_LGE_LAP1]				
				}
            } else {
                throw new IllegalStateException("Unexpected phone type: " + phoneType);
            }
 //  20100315 LGE EXCUSE_MESSAGES START comespain@lge.com 
        mSubMenuExcuseMessages = (PreferenceScreen)findPreference(BUTTON_EXCUSE_MESSAGES_KEY);
 //  20100315 LGE EXCUSE_MESSAGES END
// LGE_VT START
		mButtonVTSetting = (PreferenceScreen)findPreference(BUTTON_CB_VT_SETTING_KEY);

		if (mButtonVTSetting != null) {
	        mVTSettingIntent = new Intent(Intent.ACTION_MAIN);
	        mVTSettingIntent.setClassName(this, VTSetting.class.getName());
	        mButtonVTSetting.setIntent (mVTSettingIntent);
		}
// LGE_VT END
		...
		if(StarConfig.OPERATOR.equals("SKT") == false){
		        // LGE_CALL_COSTS START
		        if (mSubMenuCallCostSettings != null) {
		            mCallCostSettingIntent = new Intent(Intent.ACTION_MAIN);
		            mCallCostSettingIntent.setClassName(this, CallCostSettings.class.getName());
		            mSubMenuCallCostSettings.setIntent (mCallCostSettingIntent);
		        }
		        // LGE_CALL_COSTS END
		}        
     // 2010-03-15, Call Duration cutestar@lge.com
        mButtonCDExpand = (PreferenceScreen) findPreference(BUTTON_CD_EXPAND_KEY);
        
        // 2010-03-15, Call Duration cutestar@lge.com
        if (mButtonCDExpand != null) {
        mCDSettingIntent = new Intent(Intent.ACTION_MAIN);
        mCDSettingIntent.setClassName(this, CallDurationSetting.class.getName());
        mButtonCDExpand.setIntent (mCDSettingIntent);
        }
        
        
//  LGE EXCUSE_MESSAGES START comespain@lge.com 
        if (mSubMenuExcuseMessages != null) {
            mExcuseMessagesIntent = new Intent(Intent.ACTION_MAIN);
            mExcuseMessagesIntent.setClassName(this, ExcuseMessagesList.class.getName());
            mSubMenuExcuseMessages.setIntent (mExcuseMessagesIntent);
        }
//  LGE EXCUSE_MESSAGES END comespain@lge.com
		if(StarConfig.OPERATOR.equals("SKT")){
		...
		// 2010-02-23, CALL_BARRING_SWI : Call Barring From Swift
				if (mButtonCBExpand != null) {
			        mCBSettingIntent = new Intent(Intent.ACTION_MAIN);
			        mCBSettingIntent.setClassName(this, CallBarringSetting.class.getName());
			        mButtonCBExpand.setIntent (mCBSettingIntent);
				}
		}
        ...
        {
			if(StarConfig.OPERATOR.equals("SKT")){
	        	Log.e(LOG_TAG, "icicle != null   and icicle : "  + icicle);
				...
				{
					if (DBG)
						Log.d(LOG_TAG, "onCreate:  clirArray[0]=" + clirArray[0]
    ...
    protected void onSaveInstanceState(Bundle outState) {
		...
		if(StarConfig.OPERATOR.equals("SKT")){
	        if (mCLIRButton.clirArray != null) {
	            Log.d(LOG_TAG, "Save mCLIRButton.clirArray   clirArray[0]=" + mCLIRButton.clirArray[0]
	                                      							+ ", clirArray[1]=" + mCLIRButton.clirArray[1]);
...
// LGE_CUSTOMER_SERVICE_PROFILE END
// LGE_TWO_LINE_SERVICE START
        mEnablePreference = !mPhone.getIccCard().getIccFdnEnabled();
        Log.d("callfeateures","enablePreference: "+mEnablePreference);
		if(StarConfig.OPERATOR.equals("SKT") == false){
		        mButtonCBExpand.setEnabled(mEnablePreference);
		        PreferenceScreen mButtonCFExpand = (PreferenceScreen)findPreference("button_cf_expand_key");
		        mButtonCFExpand.setEnabled(mEnablePreference);
		        if (!mPhone.isTwoLineSupported()){
		           PreferenceScreen mButtonMoreExpand = (PreferenceScreen)findPreference("button_more_expand_key");
		           mButtonMoreExpand.setEnabled(mEnablePreference);
		        }
		        mSubMenuCallCostSettings.setEnabled(mEnablePreference);
		}
		else
		{
		//Answer Mode Add
		if(mAnswerModeCheckBoxPreference != null) {
			int answerMode = Settings.Secure.getInt(getContentResolver(), Settings.Secure.ANSWER_SETTING, 0);		
			mAnswerModeCheckBoxPreference.setChecked(answerMode != 0);
		}
		}

//        mButtonCDExpand.setEnabled(mEnablePreference);
// LGE_TWO_LINE_SERVICE END
    }
...
// LGE_CUSTOMER_SERVICE_PROFILE START
    private void checkCustomerServiceProfile() {
        mSubMenuVoicemailSettings.setEnabled(mPhone.isServiceCustomerAccessible(CspConstants.GROUPCODE_VALUEADDED_SERVICES, CspConstants.SERVICE_VPS));
        mVoicemailProviders.setEnabled(mSubMenuVoicemailSettings.isEnabled());
    }

    private boolean isCallBarringItemAccessible(String item) {
        boolean accessible = true;
        if (item.equals(CommandsInterface.CB_FACILITY_BAOIC)) {
            accessible = mPhone.isServiceCustomerAccessible(CspConstants.GROUPCODE_CALL_RESTRICTION, CspConstants.SERVICE_BOIC);
        } else if (item.equals(CommandsInterface.CB_FACILITY_BAOICxH)) {
            accessible = mPhone.isServiceCustomerAccessible(CspConstants.GROUPCODE_CALL_RESTRICTION, CspConstants.SERVICE_BOIC_EXHC);
        } else if (item.equals(CommandsInterface.CB_FACILITY_BAOC)) {
            accessible = mPhone.isServiceCustomerAccessible(CspConstants.GROUPCODE_CALL_RESTRICTION, CspConstants.SERVICE_BOAC);
        } else if (item.equals(CommandsInterface.CB_FACILITY_BAICr)) {
            accessible = mPhone.isServiceCustomerAccessible(CspConstants.GROUPCODE_CALL_RESTRICTION, CspConstants.SERVICE_BAIC);
        }
        return accessible;
    }
...
/*
                ...
                else if(mVmExceptionErrorDialog != null && mVmExceptionErrorDialog.isShowing())
                {
                    mVmExceptionErrorDialog.dismiss();
                    mLaunchVmExceptionErrorDialogAgain = true;
                }
