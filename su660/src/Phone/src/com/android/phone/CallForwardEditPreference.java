...
//LGE_ECLAIR_PORTING START
                if (( (number == null) || (number.equals("")) ) && (action != CommandsInterface.CF_ACTION_DISABLE)){
                         if (mButtonClicked != DialogInterface.BUTTON_POSITIVE) setToggled(!isToggled());
                         Toast toast = Toast.makeText(getContext(), "Number is empty", Toast.LENGTH_SHORT);
