...
//20101007 sh80.choi@lge.com Ringing Infinite (Domestic) [START_LGE_LAB1]
import com.lge.config.StarConfig;
//20101007 sh80.choi@lge.com Ringing Infinite (Domestic) [END_LGE_LAB1]
...
//20101027 sh80.choi@lge.com Vibrate Scenario 1500 - 500 [START_LGE_LAB1]
    ////private static final int VIBRATE_LENGTH = 1000; // ms	//Native
    ////private static final int PAUSE_LENGTH = 1000; // ms		//Native
    private static final int VIBRATE_LENGTH = 1500; // ms
    private static final int PAUSE_LENGTH = 500; // ms
//20101027 sh80.choi@lge.com Vibrate Scenario 1500 - 500 [END_LGE_LAB1]
     ...
     */
    //jundj@mo2.co.kr Start change visibility attribute private to public
     ...
     */
    //jundj@mo2.co.kr Start change visibility attribute private to public.s
    public void ring() {
    //jundj@mo2.co.kr End
        if (DBG) log("ring()...");
...
//20101007 wonho.moon@lge.com <mailto:wonho.moon@lge.com> Call Silent String [START_LGE_LAB]
			...
			PhoneUtils.setIsReserveCall(false);
...
//20101112 sh80.choi@lge.com Call Vibrate Volume [START_LGE_LAB1]	
				if (StarConfig.COUNTRY.equals("KR")) {
                	mVibrator.vibrate(VIBRATE_LENGTH, mVibrator.getVibrateVolume());
				} else
                    ...
                    switch (msg.what) {
                        case PLAY_RING_ONCE:
                            ...
                            if (r != null && !hasMessages(STOP_RING) && !r.isPlaying()) {
                                ...
                                //ANDY_PORTING LGDRM [lg-drm@lge.com 100414]
                                if (Drm.LGDRM) {
                                    // consume DRM right only when playing from a Ringer
                                    r.setProperty(true);
                                }
                                //ANDY_END

//20101007 sh80.choi@lge.com Ringing Infinite (Domestic) [START_LGE_LAB1]
//20101107 jongik2.kim@lge.com RING repeat
								r.play(true);
//20101007 sh80.choi@lge.com Ringing Infinite (Domestic) [END_LGE_LAB1]
                                //r.play();
                                synchronized (Ringer.this) {
