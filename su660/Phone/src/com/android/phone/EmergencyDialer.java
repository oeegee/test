...
// 2010.11.08 minji.bae@lge.com New Haptic feedback [START_LGE_LAB1]
import android.provider.Settings.System;
import android.os.Vibrator;
// 2010.11.08 minji.bae@lge.com New Haptic feedback [END_LGE_LAB1]
...
// LGE_SIM_INIT END
// 2010.11.16 minji.bae@lge.com Domestic - Emergency List Scenario Changed [START_LGE_LAB1]
import com.lge.config.StarConfig;
// 2010.11.16 minji.bae@lge.com Domestic - Emergency List Scenario Changed [END_LGE_LAB1]
...
public class EmergencyDialer extends Activity
    ...
    // 2010.11.16 minji.bae@lge.com Domestic - Emergency List Scenario Changed [START_LGE_LAB1]
    static final String ACTION_EMERGENCY_LIST = "com.android.phone.EmergencyList.VIEW";
    // 2010.11.16 minji.bae@lge.com Domestic - Emergency List Scenario Changed [END_LGE_LAB1]
    ...
    private View mList; // 2010.11.16 minji.bae@lge.com Domestic - Emergency List Scenario Changed [LGE_LAB1]
...
// LGE_SIM_INIT START
        // fill test field by data from EF_ECC
// 20100510 euikuk.jeong@lge.com Disable loading default ECC number on EmergencyDialer [START_LGE]
//        mDigits.setText(TelephonyManager.getDefault().getEcc());
// 20100510 euikuk.jeong@lge.com Disable loading default ECC number on EmergencyDialer [END_LGE]
// LGE_SIM_INIT END
        ...
        if (r.getBoolean(R.bool.config_show_onscreen_dial_button)) {
            ...
            mList = mVoicemailDialAndDeleteRow.findViewById(R.id.emergencyListButton);
            
            if ("KR".equals(StarConfig.COUNTRY)) {
                mVoicemailDialAndDeleteRow.findViewById(R.id.voicemailButton).setVisibility(View.GONE);
                ...
                mVoicemailDialAndDeleteRow.findViewById(R.id.voicemailButton).setVisibility(View.VISIBLE);
                mVoicemailDialAndDeleteRow.findViewById(R.id.voicemailButton).setEnabled(false);
            }
            // 2010.11.16 minji.bae@lge.com Domestic - Emergency List Scenario Changed [END_LGE_LAB1]
        ...
        // 2010.11.08 minji.bae@lge.com New Haptic feedback [START_LGE_LAB1]
        mHapticEnabled = Settings.System.getInt(getContentResolver(), System.HAPTIC_FEEDBACK_ENABLED, 0) == 1;
    ...
    private void keyPressed(int keyCode) {
        //mHaptic.vibrate();
        vibrate(); // 2010.11.08 minji.bae@lge.com New Haptic feedback
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            // 2010.11.16 minji.bae@lge.com Domestic - Emergency List Scenario Changed [START_LGE_LAB1]
            case R.id.emergencyListButton: {
                 if ("KR".equals(StarConfig.COUNTRY)) {
                    Intent intent = new Intent(ACTION_EMERGENCY_LIST);
    ...
    protected void onResume() {
        ...
        mHapticEnabled = Settings.System.getInt(getContentResolver(),
                System.HAPTIC_FEEDBACK_ENABLED, 0) == 1;
        // 2010.11.08 minji.bae@lge.com New Haptic feedback [END_LGE_LAB1]
