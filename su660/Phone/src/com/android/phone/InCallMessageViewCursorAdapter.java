...
public class InCallMessageViewCursorAdapter extends ResourceCursorAdapter implements View.OnClickListener {
    /**
    ...
    public InCallMessageViewCursorAdapter(Context context, int layout, Cursor c, String[] from, int[] to ,InCallTouchUi mCallUi) {
