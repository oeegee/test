...
//20100403 DIALPAD_GUI Start
/*
        mButtonWidth = child.getMeasuredWidth(); //Uses the real image width
        mButtonHeight = child.getMeasuredHeight();
*/
        mButtonWidth = child.getLayoutParams().width; //Uses the layout_width developer wrote in xml.
        mButtonHeight = child.getLayoutParams().height;
//20100403 DIALPAD_GUI End
