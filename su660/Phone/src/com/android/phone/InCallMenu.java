...
//20100409 NativeCallUI Start
//    InCallMenuItemView mDeflcet;
//20100409 NativeCallUI End
// LGE_CALL_DEFLECTION END
// LGE_CALL_TRANSFER START
//20100409 NativeCallUI Start
// Call transfer button returned because of some changing of UI (InCallMenu widget is used for outgoing calls)
    InCallMenuItemView mTransfer;
//20100409 NativeCallUI End
...
//20100409 NativeCallUI Start
/*        
        mDeflcet = new InCallMenuItemView(wrappedContext);
        mDeflcet.setId(R.id.menuDeflect);
        mDeflcet.setOnClickListener(mInCallScreen);
        mDeflcet.setText(R.string.menu_deflect);
*/        
//20100409 NativeCallUI End
// LGE_CALL_DEFLECTION END
// LGE_CALL_TRANSFER START
//20100409 NativeCallUI Start
// Call transfer button returned because of some changing of UI (InCallMenu widget is used for outgoing calls)
        mTransfer = new InCallMenuItemView(wrappedContext);
        mTransfer.setId(R.id.menuTransfer);
        mTransfer.setOnClickListener(mInCallScreen);
        mTransfer.setText(R.string.menu_transfer);
//20100409 NativeCallUI End
// LGE_CALL_TRANSFER END
        //
...
// LGE_CALL_DEFLECTION START
//20100409 NativeCallUI Start
//          mInCallMenuView.addItemView(mDeflcet, 1);
//20100409 NativeCallUI End
// LGE_CALL_DEFLECTION END
// LGE_CALL_TRANSFER START
//20100409 NativeCallUI Start
// Call transfer button returned because of some changing of UI (InCallMenu widget is used for outgoing calls)
            mInCallMenuView.addItemView(mTransfer, 1);
//20100409 NativeCallUI End
// LGE_CALL_TRANSFER END
        }
...
//20100409 NativeCallUI Start
/*
                    mDeflcet.setVisible(true);
                    mDeflcet.setEnabled(true);
*/
//20100409 NativeCallUI End
// LGE_CALL_DEFLECTION END
// LGE_CALL_TRANSFER START
...
// LGE_CUSTOMER_SERVICE_PROFILE START
                checkCustomerServiceProfile(phone);
// LGE_CUSTOMER_SERVICE_PROFILE END
...
/*        
        // "Deflect call"
        mDeflcet.setVisible(false);
        mDeflcet.setEnabled(false);
*/
//20100409 NativeCallUI End
// LGE_CALL_DEFLECTION END
// LGE_CALL_TRANSFER START
...
// Call transfer button returned because of some changing of UI (InCallMenu widget is used for outgoing calls)
        // "Transfer call"
        boolean canWarmTransfer = phone.canTransfer();
        boolean canColdTransfer = canColdTransfer(phone);
        mTransfer.setVisible(canWarmTransfer || canColdTransfer);
        mTransfer.setEnabled(canWarmTransfer || canColdTransfer);
//20100409 NativeCallUI End
// LGE_CALL_TRANSFER END
        // Swap / merge calls
...
// LGE_CUSTOMER_SERVICE_PROFILE START
    private void checkCustomerServiceProfile(Phone phone) {
        if (mMergeCalls.isEnabled()) {
            mMergeCalls.setEnabled(phone.isServiceCustomerAccessible(CspConstants.GROUPCODE_OTHER_SUPP_SERVICES, CspConstants.SERVICE_MPTY));
        }
        if (mHold.isEnabled()) {
            mHold.setEnabled(phone.isServiceCustomerAccessible(CspConstants.GROUPCODE_CALL_COMPLETION, CspConstants.SERVICE_HOLD));
        }
        if (mAnswerAndHold.isEnabled()) {
            mAnswerAndHold.setEnabled(mHold.isEnabled());
        }
//20100409 NativeCallUI Start
/*
        if (mTransfer.isEnabled()) {
            mTransfer.setEnabled(phone.isServiceCustomerAccessible(CspConstants.GROUPCODE_CALL_OFFERING, CspConstants.SERVICE_CT));
        }
*/
//20100409 NativeCallUI End
    }
